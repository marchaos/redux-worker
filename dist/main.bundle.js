...
/***/ function(module, exports, __webpack_require__) {
	...
	(function webpackMissingModule() { throw new Error("Cannot find module \"dist/lib.js\""); }());
...
/***/ function(module, exports, __webpack_require__) {
	...
	var nqueenApp = (0, _redux.combineReducers)({
		nqueen: _nqueen2.default
	});

	exports.default = nqueenApp;
...
/***/ function(module, exports) {
	...
	var startNQueen = function startNQueen(state) {
	...
	var calculateNQueen = function calculateNQueen(state, n) {
		return {
			numberOfSquares: n,
			isCalculating: true,
	...
	var completeNQueen = function completeNQueen(state) {
		return Object.assign({}, state, {
			isCalculating: false
		});
	};
	...
	exports.default = function () {
		var state = arguments.length <= 0 || arguments[0] === undefined ? intState : arguments[0];
		var action = arguments[1];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NqueenContainer = __webpack_require__(185);
	...
	var _Blinker = __webpack_require__(189);

	var _Blinker2 = _interopRequireDefault(_Blinker);

	var _Spinner = __webpack_require__(190);
	...
	var App = function App() {
		return _react2.default.createElement(
			...
			_react2.default.createElement(_NqueenContainer2.default, null),
			_react2.default.createElement(
				...
				_react2.default.createElement(_Blinker2.default, null),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Nqueen = __webpack_require__(186);

	var _Nqueen2 = _interopRequireDefault(_Nqueen);

	var _nqueen = __webpack_require__(187);

	var _nqueen2 = _interopRequireDefault(_nqueen);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var NqueenContainer = (0, _react.createClass)({
		render: function render() {
			return _react2.default.createElement(_Nqueen2.default, this.props);
		}
	});
	...
	function mapDispatcherToProps(dispatch) {
		return {
			actions: (0, _redux.bindActionCreators)(_nqueen2.default, dispatch)
		};
	}
	...
	exports.default = (0, _react.createClass)({
		getDefaultProps: function getDefaultProps() {
			return {
				...
				answer: null,
				actions: {
					calculateNQueen: function calculateNQueen() {}
				}
			};
		},
		...
		render: function render() {
			...
			var numberOfSquares = _props.numberOfSquares;
			var answer = _props.answer;
			var isCalculating = _props.isCalculating;
...
/***/ function(module, exports) {
	...
	var calculateNQueen = function calculateNQueen(n) {
		return function (dispatch) {
			dispatch({
				type: 'START_NQUEEN'
			});
